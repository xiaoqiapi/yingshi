var rule = {
    ...
    searchUrl:'https://api.linhun.vip/api/kgmv?apiKey=6d6726746e2ee6890a9a5dc03e6846ff&name=**&n=',
    searchable:2,
    quickSearch:0,
    ...
    timeout:5000,
    play_parse:true,
    lazy:'js:if(/mp4/.test(input)){input}else{var mv_name=request(input).match(/mv_name = "(.*?)"/)[1];input=JSON.parse(request("https://api.linhun.vip/api/kgmv?apiKey=6d6726746e2ee6890a9a5dc03e6846ff&name="+mv_name+"&n=1")).video}',
    tab_rename:{'在线播放':'小齐影视'}, 
    limit:6,
    推荐:'*',
